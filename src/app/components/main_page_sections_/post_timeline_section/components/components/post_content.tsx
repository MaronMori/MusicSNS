    ...
    return (
      <div className={"relative z-0"}>
        ...
        >
          <div
            className={
              "flex justify-center mb-4 bg-amber-500 py-2 rounded-2xl font-bold shadow-2xl"
            }
          >
          ...
          <div>
            ...
            <div className={"flex justify-center"}>
              {post.songData.track.artists.map((artist, index: string) => (
          ...
          {post.songData.track.preview_url ? (
            ...
            >
              {isPlayingTimelineContent &&
              previewUrl === post.songData.track.preview_url ? (
                <PauseCircleIcon
                  color={"success"}
          ...
          <div className={"mt-4"}>
            <Button
              component={"a"}
              href={post.songData.track.album.external_urls.spotify}
              className={"w-full"}
              variant={"contained"}
              sx={{
