...
export const Post_music_modal = ({userAuth, onClose, onBack, isPlaying, setIsPlaying}) => {
    ...
    const handleSubmitSongPost = async (e: any) => {
        e.preventDefault()
    ...
    const togglePlay = async (preview_url = undefined, event = undefined, name = undefined) => {
        event.preventDefault()
        await setIsPlaying(false)
        // console.log(name)
        // console.log("送ったpreview_url" + preview_url)
        // console.log("現在のpreviewUrl" + previewUrl)
        if (preview_url && !isPlaying) {
            await setPreviewUrl(preview_url)
            // console.log("previewUrlが同じ")
